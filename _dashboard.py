...
<style>
  ...
  .card{border:1px solid #333;border-radius:4px;padding:1rem;width:220px;}
  ...
  .badge{background:#1e3a5f;color:#7eb8f7;padding:.15rem .5rem;border-radius:3px;font-size:.8rem;display:inline-block;margin-top:.15rem;}
